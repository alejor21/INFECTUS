  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 space-y-8">
      ...
      <div>
        ...
        {!hasHospital && (
          <div className="mt-4 flex items-start gap-3 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700 rounded-xl px-4 py-3">
            <AlertTriangle className="w-5 h-5 text-amber-500 shrink-0 mt-0.5" />
            <p className="text-sm text-amber-700 dark:text-amber-400">
              <span className="font-semibold">Selecciona un hospital</span> en la barra superior
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5">
          ...
          <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">este hospital</p>
        </div>
        ...
        {/* Card 3 — Nivel PROA */}
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5">
          <div className="w-10 h-10 rounded-lg bg-violet-50 dark:bg-violet-900/20 flex items-center justify-center mb-3">
            <Shield
              className={`w-5 h-5 ${levelConf ? levelConf.iconCls : 'text-gray-400 dark:text-gray-500'}`}
            />
          </div>
          <p className="text-xs text-gray-500 dark:text-gray-400 font-medium mb-1">
            Nivel PROA actual
          ...
          <p
            className={`text-2xl font-bold ${
              dataLoading
                ? 'opacity-40 animate-pulse text-gray-800 dark:text-white'
                : levelConf
                  ? levelConf.cls
          ...
          <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">última evaluación</p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5">
          ...
          <p className="text-xs text-gray-400 dark:text-gray-500 mt-1">desde Excel</p>
        </div>
      </div>
      ...
      {hasNoData && (
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {/* Step 1 */}
            <div className="relative bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5 pt-7">
              <span className="absolute -top-3 left-5 w-7 h-7 bg-indigo-600 text-white text-xs font-bold rounded-full flex items-center justify-center shadow-sm">
                1
              </span>
            ...
            <div className="relative bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-5 pt-7">
              ...
              <ClipboardCheck className="w-10 h-10 text-violet-400 mb-3" />
              <h3 className="font-semibold text-gray-800 dark:text-white mb-1">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
          ...
          <button
            onClick={() => navigate('/evaluacion')}
            className="group p-5 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-indigo-300 dark:hover:border-indigo-700 hover:shadow-md cursor-pointer transition-all duration-200 hover:-translate-y-0.5 text-left"
          >
            <div className="w-10 h-10 rounded-lg bg-indigo-50 dark:bg-indigo-900/20 flex items-center justify-center mb-3">
              <ClipboardCheck className="w-5 h-5 text-indigo-500" />
            </div>
          ...
          <button
            ...
            className="group p-5 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-teal-300 dark:hover:border-teal-700 hover:shadow-md cursor-pointer transition-all duration-200 hover:-translate-y-0.5 text-left"
          >
            <div className="w-10 h-10 rounded-lg bg-teal-50 dark:bg-teal-900/20 flex items-center justify-center mb-3">
          ...
          <button
            onClick={() => navigate('/hospitales')}
            className="group p-5 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-violet-300 dark:hover:border-violet-700 hover:shadow-md cursor-pointer transition-all duration-200 hover:-translate-y-0.5 text-left"
          >
            <div className="w-10 h-10 rounded-lg bg-violet-50 dark:bg-violet-900/20 flex items-center justify-center mb-3">
          ...
          <button
            ...
            className="group p-5 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-amber-300 dark:hover:border-amber-700 hover:shadow-md cursor-pointer transition-all duration-200 hover:-translate-y-0.5 text-left"
          >
          ...
          <button
            ...
            className="group p-5 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-emerald-300 dark:hover:border-emerald-700 hover:shadow-md cursor-pointer transition-all duration-200 hover:-translate-y-0.5 text-left"
          >
            <div className="w-10 h-10 rounded-lg bg-emerald-50 dark:bg-emerald-900/20 flex items-center justify-center mb-3">
          ...
          <button
            ...
            className="group p-5 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 hover:border-rose-300 dark:hover:border-rose-700 hover:shadow-md cursor-pointer transition-all duration-200 hover:-translate-y-0.5 text-left"
          >
            <div className="w-10 h-10 rounded-lg bg-rose-50 dark:bg-rose-900/20 flex items-center justify-center mb-3">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        {modulesOpen && (
          <div className="border-t border-gray-100 dark:border-gray-700 px-5 pt-4 pb-5">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {MODULE_CARDS.map((mod) => (
                <div key={mod.title} className="flex gap-3">
                  <div
                    className={`w-9 h-9 rounded-lg flex items-center justify-center shrink-0 ${mod.bgCls}`}
                  >
                    <mod.Icon className={`w-4 h-4 ${mod.iconCls}`} />
                  </div>
                  <div>
        ...
        <div>
          ...
          {stats.recentEvals.length === 0 ? (
            <p className="text-sm text-center text-gray-400 dark:text-gray-500 py-8">
              No hay actividad reciente. ¡Crea tu primera evaluación!
            </p>
          ) : (
              ...
              {stats.recentEvals.map((ev) => {
                ...
                return (
                  <button
                    key={ev.id}
                    onClick={() => navigate('/evaluacion')}
                    className="w-full flex items-center gap-3 px-5 py-4 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors text-left min-h-[44px]"
                  >
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      <span
                        className={`text-xs font-medium px-2 py-0.5 rounded-full ${statusConf.cls}`}
                      >
                        {statusConf.label}
                      </span>
