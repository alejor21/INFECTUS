...
const COLORS = ['#0B3C5D', '#0F8B8D', '#F59E0B', '#DC2626', '#8DD3D5', '#D1D5DB'];

interface OrganismDistributionChartProps {
  data: { type: string; count: number }[];
}

export function OrganismDistributionChart({ data }: OrganismDistributionChartProps) {
